  ...
  return (
    <div className="bg-blueGray-100 min-h-screen p-6 font-sans px-3 py-3">
      <div className="bg-blueGray-800 text-white p-4 rounded flex justify-between items-center">
        <div>
          <p className="m-0">Name: <strong>{userData.fname}</strong></p>
          <p className="m-0">Email: <strong>{userData.email}</strong></p>
        </div>
        <div>
          <button onClick={() => setShowForm(!showForm)} className="bg-blueGray-600 text-white px-4 py-2 rounded shadow hover:bg-blueGray-700 mr-2">
            {showForm ? "Close Form" : "Create New Project"}
          </button>
      ...
      <h1 className="text-blueGray-800 text-center mt-4"><b>Project Director Dashboard</b></h1>
      ...
      {showForm && (
        <div className="bg-white p-6 mt-4 rounded shadow-md max-w-lg mx-auto px-4 ">
          ...
          <form onSubmit={handleCreateProject}>
            ...
            <div className="mb-4">
              <label className="block text-blueGray-600">Number of Members</label>
              <input
                type="number"
                name="numMembers"
                value={newProject.numMembers}
            ...
            <button type="submit" className="bg-blueGray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150">
              Create Project
            </button>
          </form>
        </div>
