...
//       <button onClick={() => toggleQueryForm()} className="bg-blueGray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none mt-4 ease-linear transition-all duration-150 mb-3" >
//                             Create Query
//                           </button>
...
//                                   Requirement id:
//                                 </label>
//                                 <input  name="requirement.id"></input>
//                                 <label className="block text-blueGray-600 text-sm font-bold mb-2">
//                                   Enter your query:
//                                 </label>
//                                 <textarea
