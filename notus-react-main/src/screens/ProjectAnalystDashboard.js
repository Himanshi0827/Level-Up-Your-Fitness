...
//     fetch(`http://localhost:5000/requirements?projectId=${project.id}`)
//       .then((response) => response.json())
//       .then((data) => {
//         setRequirements(data);
//         requirementRefs.current = data.reduce((acc, requirement) => {
//           acc[requirement.id] = React.createRef();
//           return acc;
//         }, {});
//       })
...
//     if (requirement && requirementRefs.current[requirement.id]) {
//     requirementRefs.current[requirement.id].current.scrollIntoView({
//     behavior: "smooth",
//     block: "start",
//     });
//     } else {
...
//                       <td className="py-2 px-4 border-b border-blueGray-300">{project.title}</td>
//                       <td className="py-2 px-4 border-b border-blueGray-300">{project.manager}</td>
                      
//                       <td className="py-2 px-4 border-b border-blueGray-300">{project.Description}</td>
//                       <td className="py-2 px-4 border-b border-blueGray-300">{project.date}</td>
//                       <td className="py-2 px-4 border-b border-blueGray-300">{project.ClientName}</td>
//                       <td className="py-2 px-4 border-b border-blueGray-300">{project.Status}</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
...
//                       <h3 className="text-blueGray-600 text-xl font-bold mt-4">
//                         Requirements for {selectedProject.title}
//                       </h3>
//                       <div className="mt-4">
...
//                         <div
//                           key={requirement.id}
//                           ref={requirementRefs.current[requirement.id]}
...
//             <ul>
//               {requirements.map((requirement) => (
//                 <li key={requirement.id} className="bg-white p-4 my-2 rounded shadow-md">
...
//                 >
//                   <h4 className="text-blueGray-700 font-bold">{project.title}</h4>
//                   <p className="text-blueGray-500">Manager: {project.manager}</p>
//                 </div>
//               ))}
//               {selectedProject && (
//                 <div className="flex flex-wrap mt-4">
...
//                             {queryForms[requirement.id] && (
//                               <form
//                                 onSubmit={(e) => handleQueryFormSubmit(e, requirement.id)}
//                                 className="mt-4 bg-blueGray-50 p-4 rounded shadow-inner"
//                               >
...
//                                   <textarea
//                                     name="query"
//                                     value={queryInputs[requirement.id]?.query || ""}
//                                     onChange={(e) => handleQueryInputChange(e, requirement.id)}
//                                     className="form-control w-full px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring ease-linear transition-all duration-150"
//                                   />
//                                 </div>
//                                 <div className="form-group mb-4">
...
//                                   <select
//                                     name="priority"
//                                     value={queryInputs[requirement.id]?.priority || ""}
//                                     onChange={(e) => handleQueryInputChange(e, requirement.id)}
//                                     className="form-control w-full px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring ease-linear transition-all duration-150"
//                                   >
//                                     <option value="low">Low</option>
