...
//           Register
//         </button>
//         <button className="btn mx-3 " href="/sign-in">
//           Login
//         </button>
//       </div>
//     </div>
...
//           Register
//         </Link>
//         <Link to="/sign-in" className="btn mx-3">  {/* Use Link component */}
//           Login
//         </Link>
//       </div>
//     </div>
...
//           <div key={project.id}>
//             <p>
//               {project.name} | {project.client} | {project.status} | CP{' '}
    ...
    <div className="main-wrapper">
       <header className="header">
        <div className="container">
          <div className="header-main d-flex justify-content-between align-items-center">
            ...
            <button type="button" className="header-hamburger-btn js-header-manu-toggler">
              <span></span>
            </button>
            <div className="header-backdrop js-header-backdrop"></div>
            <nav className="header-menu js-header-manu">
              <button type="button" className="header-close-btn js-header-manu-toggler">
                <i className="fas fa-times"></i>
              </button>
              <ul className="menu">
                <li className="menu-item"><Link to="/">Home</Link></li>
                <li className="menu-item"><Link to="/sign-in">Login</Link></li>
                <li className="menu-item"><Link to="/sign-up">Registration</Link></li>
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="banner-text">
                ...
                <h1 className="mb-3 text-capitalize">best for project Management and cp calculation</h1>
                <p className="mb-4">
                Manage your client requirements efficiently and effectively.
                </p>
                <Link to="/sign-in" className="btn btn-theme">Login</Link>
                
                
                <Link to="/sign-up" className="btn btn-theme mx-5">Register</Link>
              </div>
            </div>
                ...
                <div className="circular-img">
                  <div className="circular-img-inner">
                    <div className="circular-img-circle">
                      <img src="./img/downloisag-nad-removebg-preview.png" alt="banner img" className="centered-logo" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* <section className="fun-facts-section">
       ...
       <div className="d-flex justify-content-center mt-4">
         ...
         <Link to="/sign-in" className="btn mx-3"> 
           Login
         </Link>
       </div>
     </div>
          ...
          <div className="row justify-content-center">
            <div className="col-md-8 col-lg-6">
              <div className="img-box rounded-circle position-relative">
                <img src="./img/testimonial/1.png" className="w-100 js-testimonial-img rounded-circle" alt="testimonial img" />
              </div>
              <div id="carouselOne" className="carousel slide text-center" data-bs-ride="carousel">
                <div className="carousel-inner mb-4">
                  <div className="carousel-item active" data-js-testimonial-img="img/testimonial/1.png">
                    <div className="testimonials-item">
                      <p className="text-1">The team had done the great work in the backend also in the frontend and also completed the project in less time.</p>
              ...
              <div className="box">
                <div className="row align-items-center" >
                  <div className="col-md-17 align-items-center">
                    ...
                    <Link to="/sign-up" className="btn btn-theme">apply now</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row justify-content-between">
              <div className="col-md-3">
                <div className="footer-logo">
                  <a href="/">Project Management<span>Portal</span></a>
                </div>
                <p className="footer-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, dolorum!</p>
              </div>
              <div className="col-md-3">
                <h4>Contact</h4>
...
//                   <div className="circular-img-inner">
//                     <div className="circular-img-circle">
//                       <img src="./img/download-removebg-preview.png" alt="banner img" className="centered-logo" />
//                     </div>
//                   </div>
//                 </div>
//               </div>
